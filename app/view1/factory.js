...
.factory('getData', function($http) {
	...
	this.getUser = function(twitterId) {
		console.log("inside here*****");
      return $http({
        method: 'JSONP', 
        url: 'https://api.twitter.com/1.1/users/show.json?screen_name='+twitterId+'?callback=JSON_CALLBACK',
         headers: { 'authorization': 'OAuth oauth_consumer_key="7T3Fq2gJQhkoNn8fHegjdyro3",oauth_token=\\"55476869-HtqM8G9NZ7ht6bw3Ij8A4Qtusz8PJDBgPrMdrAZfY\\",oauth_signature_method=\\"HMAC-SHA1\\",oauth_timestamp=\\"1466971551\\",oauth_nonce=\\"dEn5E6\\",oauth_version=\\"1.0\\",oauth_signature=\\"NM0Q567acwQT8wPqu6Tai3KvMtw%3D\\"' 
      }
  	});
   }
	...
	this.tweeterUsers =[
  {
    ...
    "profile_image_url": "https://pbs.twimg.com/profile_images/547138164754616320/xVaFy3po.jpeg",
